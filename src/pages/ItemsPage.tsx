...
export default function ItemsPage() {
  ...
  const itemsByGroup = useMemo(() =>
    groups.map((g) => ({
      group: g,
      items: applyFilters(items.filter((i) => i.groupId === g.id && !i.isArchived), filters),
    })),
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:hidden">
        ...
        {!isArchiveView && !(filters.sort.by === "expiry" && filters.sort.dir === "asc") && (
          <div className="px-4 pt-3 max-w-lg mx-auto flex">
      ...
      {desktopView === "columns" && (
        <div className="hidden lg:flex overflow-x-auto gap-6 px-6 py-6 pb-24 items-start min-h-[calc(100vh-8rem)]">
      ...
      {desktopView === "single" && (
        <div className="hidden lg:block">
          ...
          {/* Sort indicator */}
          {!isArchiveView && !(filters.sort.by === "expiry" && filters.sort.dir === "asc") && (
            <div className="px-6 pt-3 max-w-xl mx-auto flex">
              <span className="flex items-center gap-1.5 text-xs bg-gray-100 text-gray-600 rounded-full px-3 py-1.5 font-medium">
                <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  <line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/>
                  <line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/>
